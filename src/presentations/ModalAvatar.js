...
const ModalAvatar = ({ image, modal, handleModal, setAvatar })=>{
            ...
            <View style={styles.modalContent}>
                <View style={styles.imageContent}>
                    <View style={styles.image}>
                        <Avatar.Image style={{backgroundColor:'#D9D5DC'}} size={50} source={image !== '' ? {uri: image} : require("../assets/images/logo.png")} />
                    </View>
                </View>
                <View style={{alignItems:'center',marginVertical:7}}>
                    <Text style={{fontSize:15,textAlign:'center'}}>¿Quieres cambiar tu imagen de perfil?</Text>
                </View>
